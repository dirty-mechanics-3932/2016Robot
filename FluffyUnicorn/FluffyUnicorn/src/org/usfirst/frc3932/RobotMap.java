...
public class RobotMap {
    ...
    public static CANTalon feederWheelsLeftWheel;
    public static CANTalon feederWheelsRightWheel;
    ...
    public static void init() {
        ...
        feederWheelsLeftWheel = new CANTalon(6);
        LiveWindow.addActuator("FeederWheels", "LeftWheel", feederWheelsLeftWheel);
        
        feederWheelsRightWheel = new CANTalon(7);
        LiveWindow.addActuator("FeederWheels", "RightWheel", feederWheelsRightWheel);
