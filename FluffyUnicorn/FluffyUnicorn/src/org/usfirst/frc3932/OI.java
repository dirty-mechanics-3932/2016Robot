...
public class OI {
    ...
    public JoystickButton wheelsOffButton;
    ...
    public OI() {
        ...
        wheelsOffButton = new JoystickButton(operatorJoy, 1);
        wheelsOffButton.whenPressed(new WheelsOff());
        wheelsOutButton = new JoystickButton(operatorJoy, 1);
        wheelsOutButton.whenPressed(new WheelsOut());
        wheelsInButton = new JoystickButton(operatorJoy, 1);
        wheelsInButton.whenPressed(new WheelsIn());
