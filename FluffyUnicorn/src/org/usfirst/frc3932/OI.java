...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("TurnTo0Degrees", new TurnTo0Degrees());
        SmartDashboard.putData("TurnTo10Degrees", new TurnTo10Degrees());
        SmartDashboard.putData("TurnTo15Degrees", new TurnTo15Degrees());
        SmartDashboard.putData("TurnTo30Degrees", new TurnTo30Degrees());
        SmartDashboard.putData("TurnTo45Degrees", new TurnTo45Degrees());
        SmartDashboard.putData("TurnTo90Degrees", new TurnTo90Degrees());
