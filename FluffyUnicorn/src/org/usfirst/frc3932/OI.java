...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("TurnWhileDriving", new TurnWhileDriving(35, 5, 10, 500));

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        SmartDashboard.putData("TurnTo10Degrees", new TurnTo(0));
        SmartDashboard.putData("TurnTo10Degrees", new TurnTo(10));
        SmartDashboard.putData("TurnTo15Degrees", new TurnTo(15));
        SmartDashboard.putData("TurnTo30Degrees", new TurnTo(30));
        SmartDashboard.putData("TurnTo45Degrees", new TurnTo(45));
        SmartDashboard.putData("TurnTo90Degrees", new TurnTo(90));
...
/*
	...
	// BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=FUNCTIONS
	public Joystick getDriverLeft1() {
		return driverLeft;
	}

	public Joystick getDriverRight1() {
		return driverRight;
	}
