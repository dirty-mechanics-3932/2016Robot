...
public class OI {
	...
	public OI() {
		...
		SmartDashboard.putData("TurnToSRXPid 0", Robot.TurnToBest(0, 5));
		SmartDashboard.putData("TurnToSRXPid 1", Robot.TurnToBest(1, 5));
		SmartDashboard.putData("TurnToSRXPid -1", Robot.TurnToBest(-1, 5));
		SmartDashboard.putData("TurnToSRXPid 3", Robot.TurnToBest(3, 5));
		SmartDashboard.putData("TurnToSRXPid -3", Robot.TurnToBest(-3, 5));
		SmartDashboard.putData("TurnToSRXPid 10", Robot.TurnToBest(10, 5));
		SmartDashboard.putData("TurnToSRXPid -10", Robot.TurnToBest(-10, 5));
		SmartDashboard.putData("TurnToSRXPid 45", Robot.TurnToBest(45, 5));
		SmartDashboard.putData("TurnToSRXPid -45", Robot.TurnToBest(-45, 5));
		SmartDashboard.putData("TurnToSRXPid 90", Robot.TurnToBest(90, 8));
		SmartDashboard.putData("TurnToSRXPid -90", Robot.TurnToBest(-90, 8));
		...
		SmartDashboard.putData("Move 1 Foot", new DriveStraight(1, .2));
		SmartDashboard.putData("Move 3 Feet", new DriveStraight(3, .2));
		SmartDashboard.putData("Move -1 Foot", new DriveStraight(-1, .2));
		SmartDashboard.putData("Move -3 Feet", new DriveStraight(-3, .2));
