...
public class OI {
    ...
    public OI() {
        ...
        setEqualToJoy1 = new JoystickButton(driverJoy2, 1);
        setEqualToJoy1.whileHeld(new goForward());

        camera21Button = new JoystickButton(driverJoy2, 4);
        camera21Button.whenPressed(new Camera21());
        camera12Button = new JoystickButton(driverJoy2, 3);
        camera12Button.whenPressed(new Camera12());
        camera11Button = new JoystickButton(driverJoy2, 2);
        camera11Button.whenPressed(new Camera11());
        driverJoy1 = new Joystick(0);
        
        shootButton = new JoystickButton(driverJoy1, 3);
        shootButton.whenPressed(new ActivateCannon());
        shootLaunch = new JoystickButton(driverJoy1, 6);
        shootLaunch.whileHeld(new ShooterOut());
        shootFeed = new JoystickButton(driverJoy1, 5);
        shootFeed.whileHeld(new ShooterFeed());
        platformTiltToggleButton = new JoystickButton(driverJoy1, 4);
