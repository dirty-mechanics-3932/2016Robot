...
public class ShooterWheels extends Subsystem {
	...
	private final double FAST_OUT_SPEED = .75;
	private final double HALF_OUT_SPEED = 0.5; // Was .4 on 10-18
	...
	public void shoot() {
		if (Robot.robotType == Robot.ROBOTTYPES.COMPETITION) {
			leftWheel.set(FAST_OUT_SPEED);
			rightWheel.set(FAST_OUT_SPEED);
		} else {
			leftWheel.set(FAST_OUT_SPEED * 1.1);
			rightWheel.set(FAST_OUT_SPEED * 1.1);
		}
	}
