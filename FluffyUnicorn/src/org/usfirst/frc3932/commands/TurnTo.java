...
public class TurnTo extends Command {
	...
	public static final double MINI_P[][] = { { 180, .5 }, { 20, .3 }, { 10, .2 }, { 5, .15 }, { 3, .11 }, { 2, .08 },
			{ 1, .06 }, { 0, 0 } };
	public static final double COMPETITION_P[][] = { { 180, .4 }, { 20, .3 }, { 10, .25 }, { 5, .22 }, { 3, .20 }, { 2, .19 },
			{ 1, .17 }, { .75, .150 },{ 0, 0 } };
	private double activeP[][] = COMPETITION_P;
	...
	protected double getOutput(double error) {
		...
		i = (i == 0 ? 1 : i); //ensure i is at least 1 so we don't throw index out of bounds (-1) error
