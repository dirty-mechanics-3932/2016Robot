 ...
 *
 */
public class TurnToZach extends Command{
    ...
    public TurnToZach(double degrees, double timeout) {
    ...
    public TurnToZach(double degrees){
    	this(degrees, 5);
    }
...
//    	SmartDashboard.putNumber("Accumulation", controller.);
    ...
    protected boolean isFinished() {
		...
		Robot.logf("Zach Turn conv:%.0f On:%s Err:%.2f%n",convTime, controller.onTarget()? "True" : "False", controller.getError());
		if (convTime > timeout * 1000)
			return true;
